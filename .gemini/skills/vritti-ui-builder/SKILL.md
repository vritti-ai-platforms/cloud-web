...
description: Build or modify UI components, forms, and pages for Vritti AI Cloud.
---

# Vritti UI Builder

Use this skill when building or modifying web pages, forms, cards, tables, or any UI components for Vritti AI Cloud microfrontends and container applications. This includes tasks involving React components, page layouts, API integrations, or visual elements within the Vritti ecosystem.
